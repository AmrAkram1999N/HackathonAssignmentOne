...
<body style="background: rgb(26, 25, 25);">
    ...
    @if (Session::has('time'))
        <div class="alert alert-warning text-black">
            Time left for your turn in line is {{session()->pull('time',0)}} minutes
        </div>
    @endif
    ...
    <div class="card" style="width: 22rem; margin:0 auto; margin-top: 150px;">
        ...
        <form action="{{ route('getNumber') }}" method="POST">
            <div class="card-body text-center">
                <h4 class="card-title ">Your Number is: </h4>
                ...
                @csrf
                <button class="btn btn-primary" type="submit">Get Number</button>
